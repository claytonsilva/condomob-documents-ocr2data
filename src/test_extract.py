...
from extract import get_current_title, has_truncated_rows, identify_row, append_data, get_next_row_aftertruncated, merge_truncated
...
def test_get_current_title_linha_titulo():
    data = {
        'tipoDado': [ExtracTypeRow.OTHERS, ExtracTypeRow.TITLE, ExtracTypeRow.OTHERS],
...
def test_get_current_title_titulo_anterior():
    data = {
        'tipoDado': [ExtracTypeRow.TITLE, ExtracTypeRow.OTHERS, ExtracTypeRow.OTHERS],
...
def test_get_current_title_sem_titulo():
    data = {
        'tipoDado': [ExtracTypeRow.OTHERS, ExtracTypeRow.OTHERS, ExtracTypeRow.OTHERS],
        'Data': ['data0', 'data1', 'data2']
    }
    table = DataFrame(data)
    row = table.loc[2]
...
def test_get_current_title_multiplos_titulos():
    data = {
        'tipoDado': [ExtracTypeRow.TITLE, ExtracTypeRow.TITLE, ExtracTypeRow.OTHERS, ExtracTypeRow.TITLE],
...
def test_has_truncated_rows_truncated_description():
    data = {
        'tipoDado': [ExtracTypeRow.OTHERS, ExtracTypeRow.TRUNCATED_DESCRIPTION, ExtracTypeRow.OTHERS],
    }
    table = DataFrame(data)
    resultado = has_truncated_rows(table, init_index=0)
...
def test_has_truncated_rows_truncated_participant():
    data = {
        'tipoDado': [ExtracTypeRow.OTHERS, ExtracTypeRow.TRUNCATED_PARTICIPANT, ExtracTypeRow.OTHERS],
    }
    table = DataFrame(data)
    resultado = has_truncated_rows(table, init_index=0)
...
def test_has_truncated_rows_multiplos_truncated():
    data = {
        'tipoDado': [ExtracTypeRow.OTHERS, ExtracTypeRow.TRUNCATED_PARTICIPANT, ExtracTypeRow.TRUNCATED_DESCRIPTION, ExtracTypeRow.OTHERS],
    }
    table = DataFrame(data)
...
def test_identify_row_truncated_participant():
    line = Series({
        'Data': '   ',           # vazia após strip
        'Descrição': '   ',      # vazia após strip
        'Participante': 'algum valor',
        'Valor': '   '           # vazia após strip
    })
    assert identify_row(line) == ExtracTypeRow.TRUNCATED_PARTICIPANT

# Teste 1.2: Primeira coluna vazia, última coluna vazia e segunda coluna NÃO vazia → TRUNCATED_DESCRIPTION


def test_identify_row_truncated_description():
    line = Series({
        'Data': '   ',
        'Descrição': 'Texto não vazio',
        'Participante': 'qualquer coisa',
        'Valor': '   '
    })
    assert identify_row(line) == ExtracTypeRow.TRUNCATED_DESCRIPTION
...
def test_get_next_row_aftertruncated_found():
    data = {
        'tipoDado': [ExtracTypeRow.TRUNCATED_DESCRIPTION, ExtracTypeRow.OTHERS, ExtracTypeRow.ROW, ExtracTypeRow.ROW]
    }
    table = DataFrame(data)
...
def test_get_next_row_aftertruncated_not_found():
    data = {
        'tipoDado': [ExtracTypeRow.ROW, ExtracTypeRow.TRUNCATED_DESCRIPTION, ExtracTypeRow.TRUNCATED_PARTICIPANT]
    }
    table = DataFrame(data)
...
def test_get_next_row_aftertruncated_multiple():
    data = {
        'tipoDado': [ExtracTypeRow.TRUNCATED_DESCRIPTION, ExtracTypeRow.ROW, ExtracTypeRow.ROW, ExtracTypeRow.OTHERS]
    }
    table = DataFrame(data)
...
def test_get_next_row_aftertruncated_edge():
    data = {
        'tipoDado': [ExtracTypeRow.ROW, ExtracTypeRow.TRUNCATED_DESCRIPTION, ExtracTypeRow.ROW]
    }
    table = DataFrame(data)
