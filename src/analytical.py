...
from processors.llmwhisperer import process_file as process_file_llmwhisperer
...
def run(
    ...
    process_file_fn=process_file_llmwhisperer,
) -> None:
    ...
    for i, page_path in enumerate(pdf_pages_list, start=1):
        ...
        if not os.path.exists(file_txt_output) or reprocess:
            ...
            if reprocess and os.path.exists(file_txt_processed_output):
                ...
                file_txt_output = process_file_fn(page_path)
            shutil.move(
